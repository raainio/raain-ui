...
const timeframeContainers = new TimeframeContainers([
    new TimeframeContainer('polar', [new FrameContainer(now, createPolarMapValues(), true, false)]),
    new TimeframeContainer('polar_with_Radar', [new FrameContainer(addMinutes(now, 10), createPolarMapValues(), true, false)]),
    allCartesianValues,
]);
...
const switchTimeFramePolar1 = () => {
    timeframeContainers.showTimeframe('polar', now);
...
const switchTimeFramePolar2 = () => {
    mapManagement.compositeLayer.showTheFistMatchingId('polar_with_Radar');
