...
export class IconDrawer extends CartesianDrawer {
    ...
    constructor(cartesianMap2Points: (mapValue: CartesianMapValue) => { p1: Point, p2: Point },
    ...
    protected createGridValue(mapValue: IconMapValue, points: { p1: Point, p2: Point }, centerPoint: Point): GridValue {
