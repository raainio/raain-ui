...
export class TimeframeContainers {
    ...
    public addFromRadarNodeMap(radarNodeMap: RadarNodeMap, isPolar: boolean) {
    ...
    public addFromRainComputationMap(rainComputationMap: RainComputationMap, isPolar: boolean) {
